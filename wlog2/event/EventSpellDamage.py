...
class EventSpellDamage(AEventAdvancedSpell, A2EventDamage):
    def __init__(self, time, parser: EventParser):
        AEventAdvancedSpell.__init__(self, time, EventType.SPELL_DAMAGE, parser)
        A2EventDamage.__init__(self, EventType.SPELL_DAMAGE, parser)
